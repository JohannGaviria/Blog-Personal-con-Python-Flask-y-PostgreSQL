...
def init_app(config):
    ...
    app.register_blueprint(DeletePostsRoutes.main, url_prefix='/app/deletePost')

    app.register_blueprint(SearchsRoutes.main, url_prefix='/app/search')
